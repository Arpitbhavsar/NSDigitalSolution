...
class CourseCategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create course_category" do
    assert_difference('CourseCategory.count') do
      post course_categories_url, params: { course_category: { description: @course_category.description, name: @course_category.name } }
    end
  ...
  test "should update course_category" do
    patch course_category_url(@course_category), params: { course_category: { description: @course_category.description, name: @course_category.name } }
